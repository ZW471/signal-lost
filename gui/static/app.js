...
const LABELS = {
  en: {
    ...
    signal_strength: 'Signal', danger_level: 'Danger', nexus_patrol: 'Patrols',
    ...
    world_nominal: 'World state nominal.',
    ...
    menu_footer: 'UNKNOWN SIGNAL DETECTED',
    ...
    empty_world_hint: 'The city\'s shifts surface here as your link learns more.',
  ...
  zh: {
    ...
    signal_strength: '信号', danger_level: '危险', nexus_patrol: '巡逻',
    ...
    empty_world_hint: '随着链路深入，城市的变动会在此浮现。',
...
const BOOT_MESSAGES = {
  en: [
    ...
    '[SEC] Local security sweep: CLEAN',
    '[MEM] Memory archive: GAPS DETECTED',
...
const TUTORIAL_STEPS = {
  en: [
    ...
    { target: '[data-panel="traces"]', text: '<b>TRACE</b> — Traces of truth you\'ve uncovered. The deeper you dig, the more you\'ll find.', pos: 'below', activateTab: 'traces' },
    ...
    { target: '[data-panel="world"]', text: '<b>WORLD</b> — The city around you: district access, your current location, exits, points of interest — plus new status readouts as your link uncovers them.', pos: 'below', activateTab: 'world' },
  ...
  zh: [
    ...
    { target: '[data-panel="traces"]', text: '<b>痕迹</b> — 你发现的真相痕迹。挖得越深，发现越多。', pos: 'below', activateTab: 'traces' },
    { target: '[data-panel="network"]', text: '<b>人脉</b> — 你遇到的人。追踪他们的阵营、信任度和最后已知位置。', pos: 'below', activateTab: 'network' },
    { target: '[data-panel="world"]', text: '<b>世界</b> — 你周遭的城市：区域通行、当前位置、出口和兴趣点——随着链路深入，还会出现新的状态读数。', pos: 'below', activateTab: 'world' },
